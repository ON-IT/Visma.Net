...
{
	public class CreditMemoData : BaseCrudDataClass<CustomerInvoice>
	{
        /// <summary>
		///     This constructor is called by the client to create the data source.
		/// </summary>
		internal CreditMemoData(VismaNetAuthorization auth) : base(auth)
		{
		    ApiControllerUri = VismaNetControllers.CreditMemo;
		}

	    protected CreditMemoData() : base(null)
	    {
            ApiControllerUri = VismaNetControllers.CreditMemo;
