...
namespace Visma.Net.SalesOrderNG.Models
{
    ...
    public partial class CustomerLocationItemDto
    {
        ...
        /// <br/>This field will be removed with due date 1.12.2023. It is recommended to use &lt;see cref="P:Visma.net.ERP.SalesOrders.Api.Dto.CustomerLocationItemDto.ResidentialDelivery"&gt;ResidentialDelivery&lt;/see&gt; instead.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("resedentialDelivery", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.Obsolete]
        public bool ResedentialDelivery { get; set; }
