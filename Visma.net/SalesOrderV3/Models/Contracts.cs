...
namespace ONIT.VismaNetApi.SalesOrderV3.Models
{
    ...
    public partial class PatchSalesOrderCommand
    {
        ...
        /// <summary>
        /// Sets the status code for the order. Must be "Open" or "Hold".
        /// </summary>
        [Newtonsoft.Json.JsonProperty("status", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Status { get; set; }
    ...
    public partial class SalesOrderCommissionDto
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("salesPersonId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// The order's commisionable amount
        /// </summary>
