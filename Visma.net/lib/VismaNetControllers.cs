namespace ONIT.VismaNetApi.Lib
{
  internal static class VismaNetControllers
  {
    ...
    public const string CustomerInvoiceV2 = "controller/api/v2/customerinvoice";
    ...
    public const string FinancialPeriod = "controller/api/v1/financialPeriod";
    ...
    public const string PurchaseOrder = "controller/api/v1/purchaseorder";
